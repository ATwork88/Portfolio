  ...
  return (
    <section className="border-b border-line px-5 py-24 sm:px-8">
      <div className="mx-auto max-w-7xl">
        <Reveal>
          <p className="text-sm font-medium uppercase tracking-[0.18em] text-muted">Impact</p>
          <h2 className="mt-5 max-w-3xl text-balance text-4xl font-semibold leading-tight sm:text-5xl">
            Outcomes measured in work removed, systems connected, and decisions accelerated.
          </h2>
        </Reveal>
