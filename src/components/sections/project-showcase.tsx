        ...
        {categories.map((category) => (
          <button
            ...
            className={cn(
              ...
              active === category ? "border-ink bg-ink text-canvas" : "border-line bg-canvas text-muted hover:border-ink hover:text-ink",
            )}
          >
            {category}
          </button>
        ...
        {filtered.map((study, index) => (
          ...
          >
            <Link
              ...
              className="group block overflow-hidden rounded-2xl border border-line bg-canvas transition-all duration-300 hover:-translate-y-1 hover:border-ink hover:shadow-soft"
            >
              ...
              <div className={compact ? "p-5" : "p-6"}>
                <div className="flex items-start justify-between gap-4">
                  <p className="text-xs font-medium uppercase tracking-[0.16em] text-muted">{study.category}</p>
                ...
                <p className="mt-4 text-sm leading-6 text-muted">{study.solution}</p>
